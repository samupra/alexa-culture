...
public class ProgressTrackingIntent implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput input) {
        String speechText = "I would be happy to help you track your progress." +
                "At this stage. I can only help you track your progress in learning AncientGreece culture" +
                ...
                + "To ensure completeness, please learn all the modules. To do that, say Alexa, I want to learn Ancient Greece History. Thank you";
